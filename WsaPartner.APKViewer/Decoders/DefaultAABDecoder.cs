...
namespace WsaPartner.APKViewer.Decoders
{
	public class DefaultAABDecoder: IFileDecoder
	{
		...
		public async Task Decode()
		{
			...
			dataModel.Signature = "Not supported for aab file.";
			dataModel.RawDumpSignature = "Not supported for aab file.";
		...
		private async Task Decode_JavaTest()
		{
			...
			{
				dataModel.AppName = "Java is not found, can't read aab manifest.";
				dataModel.RawDumpBadging = "Java is not found, can't read aab manifest.";
			}
